...
//   const [headerExchange, setHeaderExchange] = useState<any>();
//   useEffect(() => {
...
//       setUpData1(upData);
//       let exchange = (upData1 / usdt).toFixed(2);
//       setHeaderExchange(exchange);
//     }, 500);
