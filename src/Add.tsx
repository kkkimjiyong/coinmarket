...
export const Add = () => {
  ...
  const allUpbitList = [
    ...
    { market: "KRW-NU", korean_name: "누사이퍼", english_name: "Nucypher" },
    { market: "BTC-NU", korean_name: "누사이퍼", english_name: "Nucypher" },
    ...
    { market: "BTC-T", korean_name: "쓰레스홀드", english_name: "Threshold" },
    { market: "KRW-CELO", korean_name: "셀로", english_name: "Celo" },
    { market: "BTC-RAD", korean_name: "래디클", english_name: "Radicle" },
    {
      market: "BTC-AGLD",
      korean_name: "어드벤처골드",
      english_name: "Adventure Gold",
    },
    { market: "BTC-API3", korean_name: "에이피아이쓰리", english_name: "API3" },
    { market: "BTC-ARPA", korean_name: "알파", english_name: "ARPA" },
    {
      market: "BTC-ENS",
    ...
    { market: "BTC-GMT", korean_name: "스테픈", english_name: "Stepn" },
    { market: "BTC-APE", korean_name: "에이프코인", english_name: "ApeCoin" },
    { market: "BTC-RAY", korean_name: "레이디움", english_name: "Raydium" },
    { market: "KRW-APT", korean_name: "앱토스", english_name: "Aptos" },
    { market: "BTC-APT", korean_name: "앱토스", english_name: "Aptos" },
    {
      market: "BTC-ACM",
      korean_name: "AC밀란",
    ...
    { market: "BTC-ASTR", korean_name: "아스타", english_name: "Astar" },
    { market: "BTC-BLUR", korean_name: "블러", english_name: "Blur" },
    {
      market: "KRW-MASK",
      korean_name: "마스크네트워크",
      english_name: "Mask Network",
    ...
    { market: "BTC-MAGIC", korean_name: "매직", english_name: "MAGIC" },
    { market: "KRW-ARB", korean_name: "아비트럼", english_name: "Arbitrum" },
    { market: "BTC-ARB", korean_name: "아비트럼", english_name: "Arbitrum" },
  ];
